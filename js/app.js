...
if(document.querySelector('.slider-programs')) {
	new Swiper('.slider-programs__body', {
		/*
		effect: 'fade',
		autoplay: {
			delay: 3000,
		...
		*/
		...
		// Arrows
		navigation: {
			nextEl: '.slider-programs__arrow_next',
			prevEl: '.slider-programs__arrow_prev',
		},
		breakpoints: {
			320: {
				slidesPerView: 1.2,
...
let tempWindowScrollY = header.offsetHeight;

document.addEventListener('scroll', () => {   
  if(window.scrollY > tempWindowScrollY) {
    header.classList.remove('_show')
    header.classList.add('_hide')
    tempWindowScrollY = window.scrollY
  } else if (window.scrollY < tempWindowScrollY) {
